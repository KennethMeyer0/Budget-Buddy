document.addEventListener("DOMContentLoaded", function () {
  ...
  // AI21 Jamba‑Instruct helper: send prompt → proxy → get chat response
  ...
  // Show your custom AI prompt modal only
  ...
  // Helper: Get storage key based on user and month/year
  ...
  // When month or year changes, clear current data and save selection
  ...
  window.login = function() {
    ...
    // Hide the entire login page so that the title and welcome message do not appear in the main UI
